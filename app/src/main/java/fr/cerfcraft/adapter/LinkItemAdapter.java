...
public class LinkItemAdapter extends RecyclerView.Adapter<LinkItemAdapter.LinkItemViewHolder>{
    FirebaseFirestore db = FirebaseFirestore.getInstance();
    Context context;
    List<Object> objects;
    CollectionReference ref;

    public LinkItemAdapter(Context context, List<Object> objects) {
    ...
    @NonNull
    @Override
    public LinkItemAdapter.LinkItemViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View adapterLayout = LayoutInflater.from(context)
                .inflate(R.layout.link, parent, false);

        return new LinkItemAdapter.LinkItemViewHolder(adapterLayout);
    }

    @Override
    public void onBindViewHolder(@NonNull LinkItemAdapter.LinkItemViewHolder holder, int position) {
    ...
    public static class LinkItemViewHolder extends RecyclerView.ViewHolder {
        ...
        public LinkItemViewHolder(@NonNull View itemView) {
            super(itemView);
